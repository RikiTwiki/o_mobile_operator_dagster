SELECT
    ...
    SUBSTR(PREVIOUS_SERVICE_NAME, 4, LENGTH(PREVIOUS_SERVICE_NAME)) AS "name",
    COUNT(PREVIOUS_SERVICE_NAME) AS "value"
...
GROUP BY TRUNC(ACTION_DATE), PREVIOUS_SERVICE_NAME
ORDER BY 1